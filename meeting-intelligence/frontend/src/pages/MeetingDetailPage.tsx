      ...
      setData((prev) => {
        ...
        const next = {
          ...
          meeting: {
            ...
            project_theme: m.project_theme,
            context_developer: m.context_developer,
            context_pm: m.context_pm,
          },
        }
        writeMeetingDetailCache(id, next)
        return next
      })
      try {
  ...
  return (
    <>
      ...
      <div className="detail-page detail-page--meeting">
        ...
        <section className="detail-block detail-block--actions panel panel--elevated">
            ...
            <ul className="detail-action-list">
              {action_items.map((a) => (
                <li key={a.id}>
                  ...
                  <div className="muted detail-action-meta">
                    {a.owner_name ?? 'Unassigned'} · priority {a.priority} · {a.status} · model{' '}
